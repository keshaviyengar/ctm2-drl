...
DDPG_DENSE = {
    'parameters': [
        '--env', 'distal-2-continuous-dense-mm-v0',
...
HER_SPARSE_2_V1 = {
    'parameters': [
        ...
        '--norm_eps', '0.01',  # epsilon used for observation normalization
        '--norm_clip', '5',  # normalized observations are cropped to this values
        '--save_path', 'policies/' + dt_string + '/her_sparse_2_v1'],
    'gpu_id': '1',
    'name': 'her_sparse_2_v1'
}
...
HER_SPARSE_2_V2 = {
    'parameters': [
        ...
        '--norm_eps', '0.01',  # epsilon used for observation normalization
        '--norm_clip', '5',  # normalized observations are cropped to this values
        '--save_path', 'policies/' + dt_string + '/her_sparse_2_v2'],
    'gpu_id': '1',
    'name': 'her_sparse_2_v2'
}
